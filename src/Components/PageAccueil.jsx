...
function PageAccueil() {
  ...
  //   ScrollReveal().reveal(".cadreblanc1", {
  //     delay: 300, // Délai avant l'animation (en millisecondes)
  //     reset: true, // Réinitialise l'animation lorsqu'elle sort de la vue
  //   });

  //   ScrollReveal().reveal(".divcentral h2", {
  //     delay: 300,
  //     reset: true,
  //   });

  //   // Ajoutez d'autres éléments avec des animations ScrollReveal ici
  // }, []);
  return (
    <>
      <Navbar />
      <div className="backgrond" id="back">
        ...
        <div className="contenaire-apropos">
          <div className="enfnt1">
            <p>
              ...
              vos besoins financiers spécifiques. Créez des budgets
              personnalisés, définissez vos objectifs et suivez vos dépenses
        ...
        <div className="contenaire-apropos">
          ...
          <div className="enfnt1">
            <p>
              ...
              utilisateurs économisent en moyenne [pourcentage ou montant] de
              plus chaque mois. Pourquoi ne pas faire partie de ces économies ?.
            </p>
          </div>
        </div>
